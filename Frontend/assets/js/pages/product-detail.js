...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // ĐÃ SỬA: Bảo mật nút Thêm vào giỏ
...
/* ─── Tích hợp sẵn bộ tạo thông báo (Toast) chống lỗi ─── */
