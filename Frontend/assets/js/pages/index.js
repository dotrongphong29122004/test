...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    // ĐÃ SỬA: Thêm khối block { } cho map để tính toán link ảnh trước khi return
    container.innerHTML = featured.map(p => {
      // Logic tự động nhận diện và nối link Backend
...
window.handleHomeAddToCart = async function (e, productId) {
  e.stopPropagation();
  // Kiểm tra login (giả sử có hàm isLoggedIn)
...
// Xuất hàm showToast ra global để các file khác dùng ké nếu cần
