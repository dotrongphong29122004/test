...
/* ─────── Filter + Sort (client-side sau khi fetch) ─────── */
function applyFilters() {
  ...
  let result = allProducts.filter(p => {
    ...
    // Điều chỉnh logic lọc danh mục: so khớp với ID (MaDM) hoặc Tên (DanhMuc) tùy theo value của radio button
